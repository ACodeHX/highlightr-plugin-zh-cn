...
class HighlightrSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        containerEl.createEl("p", { text: "开发者 " }).createEl("a", {
            text: "Chetachi 👩🏽‍💻",
        ...
        new obsidian.Setting(containerEl)
            .setName("选择高光方法")
            .setDesc(`选择在行内使用 CSS 或 CSS 类进行高亮显示。请注意，两者都有各自的优缺点。使用行内 CSS 可以避免依赖外部 CSS 文件，如果你选择导出你的笔记。CSS 类更灵活且更容易定制。`)
        ...
        stylesSetting
            .setName("选择高光样式")
            .setDesc(`根据你的设计审美，你可能想要定制你的高亮样式。通过使用下拉菜单，选择不同的荧光笔样式。根据你的主题，此插件的 CSS 可能会被覆盖。`)
            .addDropdown((dropdown) => {
            let styles = {};
      ...
      <span style="background:#CCA9FFCC;margin: 0 -0.05em;padding: 0.125em 0.15em;border-radius: 0.2em;-webkit-box-decoration-break: clone;box-decoration-break: clone;">Rounded</span>`;
        ...
        highlighterSetting
            ...
            .setDesc(`通过提供颜色名称并使用颜色选择器设置十六进制代码值来创建新的荧光颜色。在退出颜色选择器之前不要忘记保存颜色。拖放高亮颜色以更改高亮器组件的顺序。`);
        ...
        valueInput.setPlaceholder("颜色的十六进制代码");
        ...
        highlighterSetting
            ...
            button
                ...
                color && !value
                    ? new obsidian.Notice("Highlighter 缺少颜色代码")
                    : !color && value
                        ? new obsidian.Notice("Highlighter 缺少颜色名称")
                        : new obsidian.Notice("Highlighter 缺少数值"); // else
            }));
        });
        ...
        this.plugin.settings.highlighterOrder.forEach((highlighter) => {
            ...
            new obsidian.Setting(settingItem)
                ...
                button
                    ...
                    new obsidian.Notice(`删除${highlighter} `);
        ...
        donateText.appendText("如果你喜欢这个插件并考虑捐赠以支持持续开发，请使用下面的按钮!");
